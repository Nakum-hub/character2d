...
- ✓ Unique responsibilities — 85 deformer channels, each owned by exactly one L0 (build-time assert).
...
- ✓ Expression ready — 16 L2 sets compose via weighted blend without overwrite.
